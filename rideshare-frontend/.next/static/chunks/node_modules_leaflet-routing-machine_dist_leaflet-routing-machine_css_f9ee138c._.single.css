...
.leaflet-routing-icon {
  ...
  content: "";
  vertical-align: top;
  background-image: url("../media/leaflet.routing.icons.42895cef.png");
...
.leaflet-routing-container-hide .leaflet-routing-collapse-btn {
  background-image: url("../media/routing-icon.adda070d.png");
  width: 26px;
  height: 23px;
  display: block;
  position: relative;
...
/*# sourceMappingURL=node_modules_leaflet-routing-machine_dist_leaflet-routing-machine_css_f9ee138c._.single.css.map*/