...
function Map({ onMapClick, onMarkerDrag, departureCoords, destinationCoords }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Map.useEffect": ()=>{
            ...
            if ("object" !== 'undefined' && window.ymaps) {
                window.ymaps.ready({
                    "Map.useEffect": ()=>{
                        if (!mapRef.current) {
                            // Создаем карту
                        ...
                        // Обновляем маркеры при изменении координат
                        updateMarkers();
                    }
                }["Map.useEffect"]);
            }
    ...
    // Обновление маркеров и маршрута при изменении координат
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Map.useEffect": ()=>{
    ...
    const updateMarkers = ()=>{
        ...
        if (!map) return;
        // Удаляем старые маркеры и маршрут
        if (departureMarkerRef.current) {
            map.geoObjects.remove(departureMarkerRef.current);
        }
        if (destinationMarkerRef.current) {
            map.geoObjects.remove(destinationMarkerRef.current);
        }
        if (routeRef.current) {
        ...
        if (departureCoords) {
            const departureMarker = new window.ymaps.Placemark(departureCoords, {
                iconContent: 'A'
            }, {
                preset: 'islands#blueStretchyIcon',
                draggable: true
            });
            departureMarker.events.add('dragend', (e)=>{
                const coords = e.get('target').geometry.getCoordinates();
                onMarkerDrag('departure', coords);
            });
        ...
        if (destinationCoords) {
            const destinationMarker = new window.ymaps.Placemark(destinationCoords, {
                iconContent: 'B'
            }, {
                preset: 'islands#redStretchyIcon',
                draggable: true
            });
            destinationMarker.events.add('dragend', (e)=>{
                const coords = e.get('target').geometry.getCoordinates();
                onMarkerDrag('destination', coords);
            });
...
//# sourceMappingURL=_aa819a15._.js.map