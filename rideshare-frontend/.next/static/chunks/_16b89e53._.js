...
function CreateTripPage() {
    ...
    const [departureMarker, setDepartureMarker] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [destinationMarker, setDestinationMarker] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CreateTripPage.useEffect": ()=>{
            // Initialize map after Yandex Maps API is loaded
            if (window.ymaps) {
                window.ymaps.ready({
                    "CreateTripPage.useEffect": ()=>{
                        ...
                        newMap.events.add('click', {
                            "CreateTripPage.useEffect": async (e)=>{
                                const coords = e.get('coords');
                                if (isSelectingDeparture) {
                                    await handleMapClick('departure', coords);
                                    setIsSelectingDeparture(false);
                                } else if (isSelectingDestination) {
                                    await handleMapClick('destination', coords);
    ...
    const handleMapClick = async (type, coords)=>{
        try {
            // Reverse geocode the clicked coordinates
            const response = await fetch(`http://localhost:8000/api/trips/geocode_address/`, {
                method: 'POST',
                headers: {
            ...
            if (type === 'departure') {
                ...
                const newMarker = new window.ymaps.Placemark(coords, {
                    ...
                    iconCaption: 'Место отправления'
                }, {
                    preset: 'islands#blueCircleDotIcon'
                });
                map.geoObjects.add(newMarker);
                setDepartureMarker(newMarker);
                setFormData((prev)=>({
                        ...prev,
                        departure_location: data.address,
                        departure_coords: coords.join(',')
                    }));
            } else {
                if (destinationMarker) {
                    map.geoObjects.remove(destinationMarker);
                }
                const newMarker = new window.ymaps.Placemark(coords, {
                    balloonContent: data.address,
                    iconCaption: 'Место назначения'
                }, {
                ...
                setFormData((prev)=>({
                        ...prev,
                        destination_location: data.address,
                        destination_coords: coords.join(',')
                    }));
            }
            // If both locations are set, draw route
            if (formData.departure_coords && (type === 'destination' || formData.destination_coords) && type === 'departure') {
                drawRoute();
            }
        } catch (err) {
        ...
        if (value.length > 3) {
            ...
            if (location) {
                ...
                if (map) {
                    ...
                    map.setCenter(location.coordinates, 15);
                    // If both addresses are set, draw route
                    if (formData.departure_coords && formData.destination_coords) {
                        drawRoute();
                    }
                }
            }
    ...
    const drawRoute = async ()=>{
        if (!map || !formData.departure_coords || !formData.destination_coords) return;
        const [startLat, startLng] = formData.departure_coords.split(',');
        const [endLat, endLng] = formData.destination_coords.split(',');
        try {
            ...
            setError('Ошибка при расчете маршрута');
        }
    };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$script$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                src: `https://api-maps.yandex.ru/2.1/?apikey=${("TURBOPACK compile-time value", "e1b6249f-5f67-45f5-9fe5-0f12e1f02161")}&lang=ru_RU`,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "px-4 py-5 sm:px-6 bg-indigo-600",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                    className: "text-lg leading-6 font-medium text-white",
                                    children: "Создание новой поездки"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/trips/create/page.tsx",
                                    lineNumber: 297,
                                    columnNumber: 15
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        ...
                                                        className: `px-4 py-2 text-sm font-medium rounded-md ${isSelectingDeparture ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 border border-gray-300'}`,
                                                        children: "Выбрать место отправления"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/trips/create/page.tsx",
                                                        lineNumber: 312,
                                                        columnNumber: 19
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        ...
                                                        className: `px-4 py-2 text-sm font-medium rounded-md ${isSelectingDestination ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 border border-gray-300'}`,
                                                        children: "Выбрать место назначения"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/trips/create/page.tsx",
                                                        lineNumber: 326,
                                                        columnNumber: 19
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                                className: "block text-sm font-medium text-gray-700",
                                                                children: "Дата и время отправления"
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/trips/create/page.tsx",
                                                                lineNumber: 376,
                                                                columnNumber: 21
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        type: "submit",
                                                        disabled: isLoading,
                                                        className: `inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${isLoading ? 'opacity-75 cursor-not-allowed' : ''}`,
...
_s(CreateTripPage, "lxLrE+xmDS0RdUDAS8jzL9ogXLY=", false, function() {
    return [
...
_c = CreateTripPage;
var _c;
__turbopack_context__.k.register(_c, "CreateTripPage");
...
//# sourceMappingURL=_16b89e53._.js.map