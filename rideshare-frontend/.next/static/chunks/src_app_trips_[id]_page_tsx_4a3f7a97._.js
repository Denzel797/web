...
function TripDetailsPage({ params }) {
    ...
    const handleCancelBooking = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error(err instanceof Error ? err.message : 'Ошибка при отмене бронирования');
        } finally{
            setCancelling(false);
        }
    };
...
_s(TripDetailsPage, "61REOO1euVYXl1YQrtPthdHgPDU=", false, function() {
    return [
...
//# sourceMappingURL=src_app_trips_%5Bid%5D_page_tsx_4a3f7a97._.js.map