...
"[project]/src/app/trips/[id]/TripDetails.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function TripDetails({ id }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TripDetails.useEffect": ()=>{
            const fetchTrip = {
                "TripDetails.useEffect.fetchTrip": async ()=>{
                    try {
                        const accessToken = localStorage.getItem('accessToken');
                        if (!accessToken) {
                            // Redirect to login page with return URL
                            router.push(`/auth/login?returnUrl=/trips/${id}`);
                            return;
                        }
                        ...
                        if (!response.ok) {
                            const errorData = await response.json().catch({
                                "TripDetails.useEffect.fetchTrip": ()=>null
                            }["TripDetails.useEffect.fetchTrip"]);
                        ...
                        setError(err instanceof Error ? err.message : 'Error loading trip details');
                    } finally{
                        setLoading(false);
                    }
                }
    ...
    const handleStatusChange = async (newStatus)=>{
        try {
            ...
            setError(err instanceof Error ? err.message : 'Error updating trip status');
        }
    };
    // Don't show loading state if we're redirecting to login
    ...
    if (loading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            fileName: "[project]/src/app/trips/[id]/TripDetails.tsx",
            lineNumber: 120,
            columnNumber: 7
        }, this)
    }, void 0, false, {
...
_s(TripDetails, "Vy4pJp2CAaPKY95Hsu7MyFeWrwY=", false, function() {
    return [
...
//# sourceMappingURL=src_d2731dcb._.js.map